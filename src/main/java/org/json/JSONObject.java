...
public class JSONObject {
    ...
    private JSONObject(Map<?, ?> map, int n, JSONParserConfiguration jSONParserConfiguration) {
        ...
        if (map == null) {
            ...
            for (Map.Entry<?, ?> entry : map.entrySet()) {
                ...
                this.map.put(String.valueOf(entry.getKey()), JSONObject.wrap(obj, n + 1, jSONParserConfiguration));
            }
        }
    }
    ...
    static Object wrap(Object object, int n, JSONParserConfiguration jSONParserConfiguration) {
        return JSONObject.wrap(object, null, n, jSONParserConfiguration);
    }
    ...
    private static Object wrap(Object object, Set<Object> set, int n, JSONParserConfiguration jSONParserConfiguration) {
        try {
            String string;
            if (NULL.equals(object)) {
                return NULL;
            ...
            if (object instanceof Collection) {
                ...
                return new JSONArray(collection, n, jSONParserConfiguration);
            }
            ...
            if (object instanceof Map) {
                Map map = (Map)object;
                return new JSONObject(map, n, jSONParserConfiguration);
            }
